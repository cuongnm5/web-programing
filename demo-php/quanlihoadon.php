      ...
      <div class="row">
        ...
        <div class="container" style="margin-bottom: 10px;">
          ...
          <div class="col-md-12 text-right tool-datagrid">
              ...
              <a class="btn btn-circle btn-danger btn-grid btn-grid-deactive-status noactivated " href="#" title="Hủy hoạt động" style="border-radius: 22px;"><i class="fas fa-unlock-alt"></i>Hủy đơn</a>
              <a style="background-color: #00a3ff;    border-radius: 22px;
                        border-color: #00a3ff;" class="btn btn-circle btn-primary btn-grid btn-grid-active-status activated" href="#" title="Kích hoạt" style="border-radius: 22px;"><i class="fas fa-lock"></i>Duyệt đơn</a>
  ...
  <script src="assets/js/settings.js"></script>
   ...
   $('.cb-element').change(function () {
    ...
    $(".noactivated").click(function(){
      ...
      if(dataArray.length==0) alert("Bạn chưa chọn hóa đơn nào ?") ;
      else{
        var dataids = JSON.stringify(dataArray);
        $.ajax({
        type: 'POST',
        url: 'ajax/andonhang.php',
        data: {data: dataids},
        datatype: 'json',
        success: function (data) {
           window.location.href="quanlihoadon.php";
        },error: function () {
         alert("lỗi");
