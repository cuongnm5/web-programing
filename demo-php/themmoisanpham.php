...
if(isset($_POST['themmoi'])){
    ...
    if(isset($anh)&&isset($moi)&&isset($tieude)&&isset($nd)){
      move_uploaded_file($tmp_name,"img/".$anh);
          $query = "
          INSERT INTO product (name,price,imagePath,des) 
          VALUES ('$ten', '$gia', '$anh','$des' )
          ";
          echo $anh;
          ...
          header("Location: quanlisanpham.php");
            ...
            <strong>Thêm mới thất bai !</strong> 
            </center>
                 ";
          }
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <main class="body-content">
    ...
    <div class="body">
            ...
            <div class="container" style="width: 1500px;height: 660px;">
 ...
 <h6> Tên sản phẩm</h6>
 <input type="text" id="ten" class="form-control" value="" name="ten" placeholder="tên sản phẩm" required="" autofocus="">
 <h6> Giá</h6>
 <input type="number" id="email" class="form-control" value="" name="gia"  required autofocus="">
 <h6>Mô tả</h6>
 <textarea cols="5" rows="5" type="text" id="pass" name="des" class="form-control" value="" required autofocus=""></textarea>
 <h6>Ảnh sản phẩm</h6>

 <input type="file" id="image" class="form-control" name="image" placeholder="image" >

 <button class="btn btn-primary btn-block" type="submit" name="themmoi" style="margin-top:15px;width: 30%;">Thêm mới</button>
